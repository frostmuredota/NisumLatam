...
<body>
    ...
    <div class="content-wrapper">
            ...
            <div class="col-md-12 content">
				<section>
					<h1><?php echo $lang['elemIShami.php1']; ?></h1>
					<p><?php echo $lang['elemIShami.php2']; ?></p>
					<p><?php echo $lang['elemIShami.php3']; ?></p>

					<p><a href="https://youtu.be/sdqU9rQBOS8" target="_blank"><?php echo $lang['elemIShami.php4']; ?></a></p>
				</section>
				<img src="images/ShamiVideo.png" alt="Shami">
				<div>
					Compartir en
				</div>
